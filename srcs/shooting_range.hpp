...
static const uint						g_win_height =	1000;
...
#define	BALL_SPEED						(g_framerate/20.f)
#define	TARGET_SPEED(multiply)			(g_framerate/multiply)
#define	SCALE(multiplyer)				(multiplyer * g_win_height) / static_cast<float>(getTexture()->getSize().y)
