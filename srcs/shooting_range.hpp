...
static const uint						g_win_width = g_win_height/16*9;
...
#define	BALL_SPEED							(g_framerate/40.f)
#define	TARGET_SPEED(multiply)	(g_framerate/(g_win_height/multiply))
#define	SCALE(multiply)					(multiply * g_win_height) / static_cast<float>(getTexture()->getSize().y)
